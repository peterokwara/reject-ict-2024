	...
	>
		<div class="hero-content flex items-center justify-center flex-col gap-y-3.5 w-full">
			<div class="hidden sm:mb-8 sm:flex sm:justify-center">
				...
				>
					The ICT Bill 2024 call for comments deadline <span class="font-semibold text-primary">
						is due on 15th July.</span
					>
					<a
						href="https://x.com/MwangoCapital/status/1810611423837311324"
			...
			>
				The ICT Bill 2024 is here. Are you ready for it?
			</h2>
			<p
